...
describe('The user isValid method', () => {
  ...
  it('should return false when under 13yo', () => {
  ...
  it('should return false when password not containing a lowercase letter', () => {
    const user = new User('Jhon', 'Doe', 'zabuza@gmail.com', new Date('1990-01-01'), 'PASSWORD123');
  
    assert.strictEqual(user.isValid(), false);
  });
  
  it('should return false when password not containing a uppercase', () => {
    const user = new User('Jhon', 'Doe', 'zabuza@gmail.com', new Date('1990-01-01'), 'password123');
  
    assert.strictEqual(user.isValid(), false);
  });
  
  it('should return false when password not containing a number', () => {
